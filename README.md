...
relay-butler/0.0.2 darwin-x64 node-v12.22.0
...
_See code: [src/commands/init.ts](https://github.com/richardguerre/relay-butler/blob/v0.0.2/src/commands/init.ts)_
<!-- commandsstop -->
