...
_See code: [src/commands/generate.ts](https://github.com/richardguerre/relay-butler/blob/v1.1.6/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/richardguerre/relay-butler/blob/v1.1.6/src/commands/init.ts)_
<!-- commandsstop -->
